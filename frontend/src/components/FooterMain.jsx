...
const Footer = () => {
    return(
        ...
        <div className="row">
            ...
            <p className="text-muted pt-2 px-0"><i>This free software is distributed under the MIT license, click <a href="https://opensource.org/license/mit/" rel="noreferrer" target="_blank">here</a> to learn more.</i></p>
        </div>
        </footer>
    );
}
