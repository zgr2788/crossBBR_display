...
const Navbar = () => {
  ...
  const Navlink = ({text, isActive, pageArg}) => {  
    return(
      <div>
      {{  
        true : <button className="nav-link active"><p className="text-info">{ text }</p></button>,
  ...
  return(
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      <div className="container-fluid">
        <a className="navbar-brand"><h1><p className="text-primary">BBB Data Repository</p></h1></a>
